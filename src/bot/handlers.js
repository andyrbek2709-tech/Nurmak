...
export async function handleStart(ctx) {
  ...
  await ctx.reply(
    "Здравствуйте! 👋 Я помогу оформить заявку на грузоперевозку.\n\n" +
    "Расскажите, что нужно перевезти? Например:\n" +
    "\"Нужно перевезти 5 тонн строительных материалов из Москвы в Алматы\""
  );
}